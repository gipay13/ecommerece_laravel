        ...
        <section class="store-gallery" id="gallery">
            <div class="container">
                <div class="row">
                    ...
                    <!-- transition itu tab dari vue js -->
                    ...
                    <div class="col-lg-2">
                    <div class="row">
                        <!-- jika :key nya ingin diganti dengan index bisa -->
                        <!-- kenapa changeActive tidak menggunakan photo.id? -->
                        <!-- karena jika menggunakan photo.id index 0 tidak akan kebaca karena yang dibaca adalah id dari gambar yang ada di photos -->
